...
<body>
	<div id="wrap">
		...
		<div id="container">
			<div id="calWarp">
				<jsp:useBean id="calDTO" class="day0622.CalDTO" scope="page"/>
				...
				%>
				<div id="calHeader">
					<a href="calender3.jsp?month=<%=(nowMonth-1)==0 ? 12 : nowMonth-1 %>&year=<%= (nowMonth-1)==0 ? nowYear-1 : nowYear %>" title="이전 월">&lt;&lt;</a>
					<a href="calender3.jsp" title="오늘"><span class="calTitle"><%= nowYear %>.<%= nowMonth %></span></a>
					<a href="calender3.jsp?month=<%=(nowMonth+1)==13 ? 1 : nowMonth+1 %>&year=<%= (nowMonth+1)==13 ? nowYear+1 : nowYear %>" title="다음 월">&gt;&gt;</a>
				</div>
				<div id="calContainer">
					<table id="calTab">
						<thead>
