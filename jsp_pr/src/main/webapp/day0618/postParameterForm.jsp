			...
			<div class="row featurette">
				<div class="col-md-7">
					<div style="padding-left:20px">
						<form action="postParameterFormProcess.jsp" method="post" name="frm" id="frm">
							<table>	
								<tr>
									<th colspan="2"><h3>name속성의 값이 유일한 HTML Form Control(post 방식)</h3></th>
								</tr>
								<tr>
									<td>text</td>
								...
								<tr>
									<td>check</td>
									<td><input type="checkbox" name="agree" value="Y" checked="checked">동의</td>
								</tr>
								<tr>
									<td>select</td>
									<td>
								...
								<tr>
									<td>textarea</td>
									<td>
										<textarea name="ta" rows="5" cols="50">텍스트 에어리어</textarea>
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<input type="button" id="btn" class="btn btn-sm btn-primary" value="submit">
									</td>
								</tr>
							</table>
						</form>
