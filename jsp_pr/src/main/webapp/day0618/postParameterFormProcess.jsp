			...
			<div class="row featurette">
				<div class="col-md-7">
					<div style="padding-left:20px">
						<h3>name속성의 값이 유일한 HTML Form Control 값 받기(post 방식)</h3>
						<div>
						<%
						//request가 사용되기전에 읽어들이는 charset을 할꺼번에 변경할 수 있다.
						request.setCharacterEncoding("UTF-8");
						
						String text=request.getParameter("text");
						text = new String(text.getBytes("8859_1"),"UTF-8"); //8859_1의 charset의 배열로 만든걸 UTF-8 charset으로 encoding 한다.
						String pass=request.getParameter("pass");
						//pass = new String(pass.getBytes("8859_1"),"UTF-8"); //8859_1의 charset의 배열로 만든걸 UTF-8 charset으로 encoding 한다.
						String gender=request.getParameter("gender");
						//checkbox는 확인하지 않으면 nullpointer exception 발생
						String agree=request.getParameter("agree");
						String tel=request.getParameter("tel");
						String ta=request.getParameter("ta");
						//ta = new String(ta.getBytes("8859_1"),"UTF-8"); //8859_1의 charset의 배열로 만든걸 UTF-8 charset으로 encoding 한다.
						%>
							<strong>id</strong><%= text %><br>
