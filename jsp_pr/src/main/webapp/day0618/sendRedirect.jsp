...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" %>
<%
//특정 IP로 요청되면 다름 site로 이동.
String ip = request.getRemoteAddr();

String[] blockIp={"192.168.10.70","192.168.10.87","192.168.10.74"};

boolean moveFlag=false;

for(int i=0; i < blockIp.length; i++){
	if(moveFlag=ip.equals(blockIp[i])){
		break;
	}//end if
}// end for
...
if(new Random().nextBoolean()){
	//response.sendRedirect("https://www.police.go.kr/index.do");//URL
	response.sendRedirect("postParameterForm.jsp");//URI
	//페이지를 이동 하더라고 아랫줄에 코드들을 실행하고 실행된다.
	return;//리턴을 입력해줘야 아랫 코드들이 실행이되지않고 넘어간다.
}// end if
%>
<!DOCTYPE html>
...
<link rel="canonical"
	href="http://192.168.10.79/jsp_pr/common/js/color-modes.js">
<script src="http://192.168.10.79/jsp_pr/common/js/bootstrap.min.css"></script>
<meta name="theme-color" content="#712cf9">
<link href="http://192.168.10.79/jsp_pr/common/js/carousel.css" rel="stylesheet">
<style>
.bd-placeholder-img {
	font-size: 1.125rem;
	text-anchor: middle;
...
<body>
  ...
  ================================================== -->
	...
	<script src="http://192.168.10.79/jsp_pr/common/js/bootstrap.bundle.min.js"
		integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI"
		class="astro-vvvwv3sm"></script>
</body>
</html>
<%
log("asdfasfasdfasdfasdfsadfsadfsadfsdafsadfsadfasdfsadfsadfasdf");
%>