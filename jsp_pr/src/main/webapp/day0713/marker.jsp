...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0da3caa0c553b3ad26e1e6ce6fc25cd7"></script>
...
$(function(){
	...
	latlng[1] = [37.50431445450708, 127.05215427796112];
	latlng[2] = [37.505386302075685, 127.05293822539237];
	latlng[3] = [37.50423015367002, 127.0542804239121];
	latlng[4] = [37.503780766953284, 127.051794829103];
	
	var postionX = 37.5047505;
	var postionY = 127.0531719;
	
	var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(latlng[0][0],latlng[0][1]), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
// 마커 하나를 지도위에 표시합니다 
addMarker(new kakao.maps.LatLng(postionX, postionY));
...
function setCenter() {            
    // 이동할 위도 경도 위치를 생성합니다 
    var moveLatLon = new kakao.maps.LatLng(postionX, positionY);
...
function useMarker(ind){
	...
	var map2 = new kakao.maps.LatLng(latlng[ind][0],latlng[ind][1]);
